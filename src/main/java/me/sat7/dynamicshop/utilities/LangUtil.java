...
public final class LangUtil {
    ...
    public static void setupLangFile(String lang)
    {
        // 한국어
        {
            ...
            ccLang.get().addDefault("HELP.MERGE_SHOP", "Merge shops.");
            ccLang.get().addDefault("HELP.SET_DEFAULT_SHOP", "Set the default shop.");
            ccLang.get().addDefault("HELP.SHOP_PERMISSION", "Set the permissions of a shop.");
            ...
            ccLang.get().addDefault("HELP.MAXPAGES", "Set the max pages of a shop");
            ccLang.get().addDefault("HELP.SETFLAG", "Set the flags of a shop");
            ccLang.get().addDefault("HELP.SET_POSITION", "Set the position of a shop");
            ccLang.get().addDefault("HELP.FLUCTUATION", "Set random price fluctuation of a shop");
            ccLang.get().addDefault("HELP.STABILIZATION", "Set the stock stabilization of a shop");
            ccLang.get().addDefault("HELP.ACCOUNT_LINK", "Link two shops together");
            ccLang.get().addDefault("HELP.ACCOUNT_TRANSFER", "Transfer balance from a shop");
            ccLang.get().addDefault("HELP.HIDE_STOCK", "Hide the stock of a shop");
            ...
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADDHAND.1", "{HELP.PRICE}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADDHAND.2", "{HELP.INF_STATIC}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADD.1", "{HELP.PRICE}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADD.2", "{HELP.INF_STATIC}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDITALL.1", "§c주의. 값이 유효한지는 확인하지 않음.");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.1", "{HELP.PRICE}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.2", "{HELP.INF_STATIC}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.3", "§f§o인자를 0으로 입력하면 이 아이탬을 상점에서 §4제거§f합니다.");
        ...
        // 영어
        {
            ...
            ccLang.get().addDefault("HELP.DELETESHOP", "Delete an existing shop.");
            ccLang.get().addDefault("HELP.RENAME_SHOP", "Rename a shop.");
            ccLang.get().addDefault("HELP.MERGE_SHOP", "Merge shops.");
            ccLang.get().addDefault("HELP.SET_DEFAULT_SHOP", "Set the default shop.");
            ccLang.get().addDefault("HELP.SHOP_PERMISSION", "Set the permissions of a shop.");
            ccLang.get().addDefault("HELP.SETTAX", "Set the sales tax.");
            ccLang.get().addDefault("HELP.SETTAX_TEMP", "Set the sales tax temporarily");
            ccLang.get().addDefault("HELP.SHOPADDHAND", "Add held Item to shop.");
            ccLang.get().addDefault("HELP.SHOPADDITEM", "Add Item to shop.");
            ccLang.get().addDefault("HELP.SHOPEDIT", "Edit shop item.");
            ccLang.get().addDefault("HELP.PRICE", "§fFormula§7: §6median§f*§6value§f/§6stock");
            ccLang.get().addDefault("HELP.INF_STATIC", "§6median§f<§60 §f== static price     §6stock§f<§60 §f== infinite stock");
            ccLang.get().addDefault("HELP.EDITALL", "Edit all shop items");
            ccLang.get().addDefault("HELP.RELOAD", "Reload YML config files.");
            ...
            ccLang.get().addDefault("HELP.QSELL", "Quick Sell");
            ...
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADD.1", "{HELP.PRICE}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_ADD.2", "{HELP.INF_STATIC}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDITALL.1", "§cWarning. There is no sanity check. Use at your own caution.");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.1", "{HELP.PRICE}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.2", "{HELP.INF_STATIC}");
            ccLang.get().addDefault("HELP.DYNAMICSHOP_SHOPEDIT_EDIT.3", "§f§oEnter 0 for value to §4Remove§f this item.");
