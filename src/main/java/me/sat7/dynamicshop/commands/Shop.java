...
public class Shop extends BaseCommand {
    ...
    public class ShopCommand extends BaseCommand {
        ...
        @Syntax("<shop>")
        @Default
        public void onShop(Player player, @Optional String shop) {
            String shopName;
        ...
        @Description("Open the Shop edit menu")
        @CommandCompletion("@dsShops * * * *")
        @Subcommand("edit")
        @CommandPermission("dshop.admin.shopedit")
        public void onShopEdit(Player player, String shopName, String itemName, double buyValue, int median, int stock) {
            // 인자 확인
            double valueMin = 0.01;
            double valueMax = -1;

            // 수정
            editShop(player, shopName, itemName, buyValue, valueMin, valueMax, median, stock);
        }
        ...
        @Subcommand("edit")
        @CommandPermission("dshop.admin.shopedit")
        public void onShopEdit2(Player player, String shopName, String itemName, double buyValue, double valueMin, double valueMax, int median, int stock) {
            editShop(player, shopName, itemName, buyValue, valueMin, valueMax, median, stock);
        }

        private void editShop(Player player, String shopName, String itemName, double buyValue, double valueMin, double valueMax, int median, int stock) {
            // 인자 확인
            int idx;
